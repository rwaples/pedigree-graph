...
def distinct_ancestor_counts(pedigree: BuiltPedigree, depth: NDArray[np.int32], /) -> NDArray[np.int32]: ...
def descendant_path_counts(pedigree: BuiltPedigree, depth: NDArray[np.int32], /) -> NDArray[np.int64]: ...
def equivalent_generations(pedigree: BuiltPedigree, depth: NDArray[np.int32], /) -> NDArray[np.float64]: ...
